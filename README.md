...
An end-to-end sales analytics portfolio project built with Excel, Power Query, Power BI and DAX to analyse a CRM sales pipeline, validate data quality, model commercial performance and translate the results into management-facing insights.
...
---
Dashboard Preview
![CRM Sales Opportunity Analysis - Executive Overview](images/executive-overview.png)
---
Business Objective
...
The final month of each complete quarter recorded substantially higher closed-deal win rates:
June: 82.8%
September: 79.2%
December: 78.5%
...
![Sales Team Performance](images/sales-team.png)
Product & Customer Performance
![Product and Customer Performance](images/product-customer.png)
Pipeline & Sales Cycle
![Pipeline and Sales Cycle](images/pipeline-sales-cycle.png)
Insights & Recommendations
![Insights and Recommendations](images/insights.png)
Process & Limitations
![Process and Limitations](images/process-limitations.png)
---
Data Model
The final Power BI solution uses a star schema with one central opportunity fact table, three business dimensions, one shared date dimension and a dedicated measures table.
...
Engagement-cohort measures activate the second relationship with `USERELATIONSHIP`.
...
---
DAX
The final model contains 48 exported measures in the dedicated `_Measures` table.
The exact exported DAX is available here:
Exact DAX Measure Source
...
dynamic agent performance leaders
account revenue concentration using `ALLSELECTED`
---
QA Approach
...
Four dedicated QA pages are retained inside the PBIX and hidden from stakeholder navigation:
QA - Regional
QA - Products
QA - Accounts
QA - Date
Visual interactions were also tested explicitly. For example, full/open-pipeline measures intentionally ignore close-date filtering where required so that open opportunities do not disappear simply because they have no `close_date`.
---
...
GTK 500 has only 25 closed opportunities. Its approximate closed regional split is:
Central: 1
East: 1
West: 23
...
---
Project Files
Download / inspect the Power BI report
Excel EDA workbook
...
DAX - KPI, cohort, sales-cycle, productivity, ranking and concentration measures
---
What I Learned
